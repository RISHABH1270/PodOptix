...
type Recommendation struct {
	...
	CurrentCPULimit     int       `json:"current_cpu_limit"     db:"current_cpu_limit"`     // millicores — live from kube_pod_container_resource_limits
	CurrentMemLimit     int       `json:"current_mem_limit"     db:"current_mem_limit"`     // MiB       — live from kube_pod_container_resource_limits
	...
	Applied             bool      `json:"applied"               db:"applied"`               // toggled true when applied to cluster — enables cost savings calculation
